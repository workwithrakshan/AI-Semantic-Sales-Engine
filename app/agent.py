...
#Change the above API key to your actual AnythingLLM API key or anything according to what u do / env file is just to view editing there will not reflect in the code 
